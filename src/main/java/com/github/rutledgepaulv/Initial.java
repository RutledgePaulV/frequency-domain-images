...
import com.github.rutledgepaulv.graphics.Window;
import com.github.rutledgepaulv.handlers.MouseHandler;
import com.github.rutledgepaulv.utilities.ImageMatrix;
import com.github.rutledgepaulv.utilities.Manipulator;
...
public class Initial {
    public static void main(String[] args) throws IOException {
        ...
        //reading in an image
        BufferedImage input = ImageIO.read(Initial.class.getClassLoader().getResource("Images/clown.png"));
        ...
        //creating windows
        Window window0 = new Window(input.getWidth(), input.getHeight(), "temp");
        ...
        window1.pane.SetBuffer(inverse_frequency.matrix);
